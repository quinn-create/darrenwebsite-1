...
// Added for this site: the page navigation (components/NavTabs.tsx) reuses the tab styles on
// plain links, because tabs switch panels in one page and must not be used for moving between pages.
