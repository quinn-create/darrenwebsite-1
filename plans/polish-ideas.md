...
8. **Speed polish** (Amazon's focus on speed). **Planned 25 Sep 2026:** `plans/speed-check-plan.md` (stop the font jump on phones, keep page text out of the JavaScript, and a repeatable `npm run speed` test with budgets).
