...
| D3 | About-page photo shape | (a) The same upright crop, from the genuine part of the photo | Open (default in use) | — | — | The site uses (a), marked in `site/components/Portrait.tsx` |
